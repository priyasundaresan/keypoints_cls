...
# dataset
workers=0
dataset_dir = 'two_rope_endpoints'
...
train_dataset = KeypointsDataset('/host/data/%s/train'%dataset_dir, IMG_HEIGHT, IMG_WIDTH, transform, gauss_sigma=GAUSS_SIGMA)
train_data = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=workers)

#test_dataset = KeypointsDataset('/host/data/%s/test'%dataset_dir, IMG_HEIGHT, IMG_WIDTH, transform, gauss_sigma=GAUSS_SIGMA)
